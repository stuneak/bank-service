...
// Source: github.com/stuneak/simplebank/sqlc_internal (interfaces: Store)
...
import (
	...
	sqlc_internal "github.com/stuneak/simplebank/sqlc_internal"
)
...
func (m *MockStore) TransferTx(arg0 context.Context, arg1 sqlc_internal.TransferTxParams) (sqlc_internal.TransferTxResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TransferTx", arg0, arg1)
	ret0, _ := ret[0].(sqlc_internal.TransferTxResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
