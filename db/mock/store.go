...
// Source: github.com/stuneak/simplebank/db/sqlc_custom (interfaces: Store)
...
import (
	...
	sqlc_custom "github.com/stuneak/simplebank/db/sqlc_custom"
)
...
func (m *MockStore) TransferTx(arg0 context.Context, arg1 sqlc_custom.TransferTxParams) (sqlc_custom.TransferTxResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TransferTx", arg0, arg1)
	ret0, _ := ret[0].(sqlc_custom.TransferTxResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
